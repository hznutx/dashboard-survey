      ...
      <Table sx={{ minWidth: 400 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="right">นครปฐม</TableCell>
            <TableCell align="right">พระนครศรีอยุธยา</TableCell>
            <TableCell align="right">ฉะเชิงเทรา</TableCell>
            <TableCell align="right">นอกพื้นที่ศึกษา</TableCell>
          </TableRow>
        </TableHead>
        <TableBody
          sx={{
